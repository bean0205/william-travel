// filepath: /Users/williamnguyen/Documents/william travel/frontend/src/components/admin/UserStatistics.tsx
        ...
        <CardContent className="pt-0">
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                layout="vertical"
                data={stats.usersByCountry.slice(0, 10)} // Display top 10 countries
                margin={{
                  top: 5,
                  right: 30,
                  left: 60,
